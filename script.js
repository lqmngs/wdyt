$(document).ready(function () {
    ...
    var content = [{
        ...
        title: "I Have Crush On You!!",
        desc: "Mungkin itu sebuah kalimat yg cukup simpel, kalimat yang menyimpan banyak harapan juga keraguan dibaliknya. Ada harapan yg ingin rasa suka itu tidak jatuh sendirian, juga ada yg harus disiapkan agar bisa menerima konsekuensinya."
    }, {
       title: "",
       desc: "Menyatakan perasaan itu hal yg cukup serius, banyak yg akan dikorbankan termasuk hasil akhirnya melepas hal yg sudah Iama tersimpan itu cukup melegakan dan bukan hal yg mudah. Disini Aku cuman mau ungkapin perasaan aku sama kamu, sejutannya itu semua diluar kendali aku, aku gamau kita jauh, aku gamau kita asing. Tapi bagaimana kalo itu kemauan kamu? aku bakal ngebiasain diri, karna cinta juga ga selamanya harus meliliki kan."    
    }, {
        title: "",
        desc: "Aku tidak tahu perasaan kamu ke aku bagaimana, yang aku tahu kamu tuh bikin nyama, rasanya kayak rumah. Kalau kamu butuh sesuatu bisa kabarin aku. Aku akan selalu ada buat kamu. Kamu bisa cerita apapun ke aku. Saat ini cuma notif dari kamu yang selalu kutunggu. Setidaknya sampai detik ini aku selalu usahakan yang terbaik buat kamu, buat kita, kalau itu semua masih kurang ataupun aku yang salah aku minta maaf. Hopefully we can spend more time together."     
    }, {
        title: "i love you more than u know",
        desc: "aku cuma ungkapin perasaan ku aja :)"
 }];
    var currentPage = 0;
    //generate content
